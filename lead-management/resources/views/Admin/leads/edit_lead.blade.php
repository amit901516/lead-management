  ...
  <div class="main-panel">
            ...
            @if(session()->has('message'))
                ...
                <div class="div_center">
                    <h1 class="font_size">Edit Lead</h1>
                   <form action="{{url('/edit_lead_confirm',$lead->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                        <div class="row">
                            ...
                            <div class=" div_design mt-2 col-lg-6">
                                ...
                                <select class="text_color" name="lead_source" required=""  style="width: 42%; height: 44px; padding: 8px;">
                                    ...
                                    <option value="{{ $lead->lead_source }}"> {{ $single }}</option>
                                    @endforeach
                                </select>
                            </div> 
                            @php
                            ...
                            <div class=" div_design mt-2 col-lg-6">
                                ...
                                <select class="text_color" name="lead_status" required=""  style="width: 42%; height: 44px; padding: 8px;">
                                    ...
                                    <option value="{{ $lead->lead_status }}" > {{ $single }}</option>
                                    @endforeach
                                </select>
                            </div>
                                        <!--=======Address========-->
                            ...
                            <div class=" div_design mt-2 col-lg-6">
                                <label>Street :</label>
                                <input class="text_color" type= "text" name="street" placeholder="" value="{{$lead->street}}" >
                            </div>

                            <div class=" div_design mt-2 col-lg-6">
                                <label>City :</label>
                                <input class="text_color" type= "text" name="city" placeholder="" value="{{$lead->city}}" >
                            </div>

                            <div class=" div_design mt-2 col-lg-6 ">
                                <label>State :</label>
                                <input class="text_color" type= "text" name="state" placeholder="" value="{{$lead->state}}" >
                            </div>

                            <div class=" div_design mt-2 col-lg-6">
                                <label>Zip Code :</label>  
                                <input class="text_color" type= "text" name="zip_code" placeholder="" value="{{$lead->zip_code}}" >
                            </div>
                            ...
                            <div class=" div_design mt-2 col-lg-12">
                                ...
                                <textarea name="description"  value="{{$lead->description}}" class="text_color" rows="4" aria-label="With textarea" spellcheck="false"  style="width: 70%;"></textarea>
                            </div>
                            ...
                            <div class="div_design  ">
                                ...
                                <input type= "submit"  style="background: #005cbf;" value="Edit Lead" class="btn btn-primary" >
                            </div>
